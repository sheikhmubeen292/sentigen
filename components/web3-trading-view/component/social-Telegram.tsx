...
export default function SocialTelegram() {
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="col-span-1 sm:col-span-2 bg-[#181B1C] rounded-[16px] p-4">
          <CardContent className="mt-2 p-0 px-2">
            <Image
              ...
              className="mb-2"
            />
            <h2 className="text-white text-lg font-semibold">On Telegram</h2>
        ...
        <Card className="bg-[#181B1C] w-full  border-none rounded-[16px] items-center flex justify-between">
          <CardContent className="p-6 ">
            <div className="w-full">
              <h3 className="text-xs text-[#F2F2F2] mb-3">Trending Topic</h3>
              <p className="text-[#fff] text-2xl mb-2 font-normal">
                Hype around the latest release
              </p>
              <div className="flex items-center justify-start gap-5 md:gap-0 md:justify-between mt-1  w-ful">
                <div className="">
                  <p className="text-xs text-[#7A7A7A]">Bullish Rating</p>
                  <p className="text-xs text-[#F2F2F2]">85%</p>
                </div>
                <div className="w-[100px]  md:w-[90px]">
                  <p className="text-xs text-[#7A7A7A]">Mentions</p>
                  <p className="text-xs text-[#F2F2F2]">5.1k</p>
                </div>
              </div>
              <div className="flex items-center justify-start gap-5 md:gap-0 md:justify-between mt-2">
                <div className="">
                  <p className="text-xs text-[#7A7A7A]">User Posts</p>
                  <p className="text-xs text-[#F2F2F2]">85%</p>
                </div>
                <div className="md:w-[90px] ml-3 md:ml-0">
                  <p className="text-xs text-[#7A7A7A]">New Members</p>
                  <p className="text-xs text-[#F2F2F2]">5.1k</p>
                </div>
              </div>
            </div>
        ...
        <Card className="bg-[#181B1C] w-full  border-none rounded-[16px] items-center flex justify-between">
          <CardContent className="p-6  w-full">
            <div>
              <h3 className="text-xs text-[#F2F2F2] mb-3">
                Top Telegram Channels
              </h3>
              <div className="flex items-center justify-between w-full">
                <p className="text-[#fff] text-sm mb-1 font-normal">
                  SNTI Empire{" "}
                </p>
                <ExternalLink className="w-4 h-4  text-[#7A7A7A]" />
              </div>
              <p className="text-xs text-[#7A7A7A]">23k members</p>
              ...
              <p className="text-xs text-[#7A7A7A]">21.3k members</p>
              ...
              <p className="text-xs text-[#7A7A7A]">18.2k members</p>
            </div>
          </CardContent>
        </Card>
      </div>
